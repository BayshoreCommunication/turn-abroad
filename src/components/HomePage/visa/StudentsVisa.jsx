...
const StudentsVisa = () => {
  const [activeIndex, setActiveIndex] = useState(0); // Active Tab State

  return (
    <section className="py-10 lg:py-14 xl:py-16 bg-white relative">
      <Motion effect="fade-up" duration="1500">
        <div className="container">
          ...
          <div className="relative">
            <Tabs selectedIndex={activeIndex}>
              ...
              >
                ...
                />
                {/* Tabs */}
                {["USA", "UK", "Canada"].map((tab, index) => (
                  <Tab
                    key={index}
                    role="tab"
                    onClick={() => setActiveIndex(index)}
                    className={`tab text-base lg:text-xl font-semibold lg:font-extrabold p-2 px-4 lg:px-11 h-12 lg:h-14 focus:outline-none outline-none w-full relative z-10 ${
