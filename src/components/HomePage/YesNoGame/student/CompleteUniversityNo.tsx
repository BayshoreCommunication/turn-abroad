...
const CompleteUniversityNo: React.FC = () => {
  return (
      ...
      <div className="container">
        <div className="flex flex-col gap-4  justify-center items-center min-h-[50vh]">
          ...
          <div className=" flex flex-col lg:flex-row gap-4 md:gap-6">
            <div className="p-10  border rounded-2xl flex flex-col  items-start justify-center max-w-[535px] shrink-0">
              <h4 className="text-lg md:text-2xl font-semibold mb-3">
                Your chances of TurningAbroad is{" "}
                <span className="text-[#2D8FCC]">70.1%</span>
              </h4>
              ...
              <span className="text-base text-center mt-4 font-semibold text-[#2D8FCC]">
                Dependent on the degree program you are getting into
              </span>
            </div>
            <div className="p-10  border rounded-2xl flex flex-col  items-start justify-center max-w-[535px] shrink-0">
              <h4 className="text-lg md:text-2xl font-semibold mb-3">
                Your chances of TurningAbroad{" "}
                <span className="text-[#2D8FCC]">with Turnabroad is 100%</span>
              </h4>
              <p className="text-base md:text-lg font-medium text-[#6E767E]">
                Breakdown with Turnabroad
              </p>
              <div className="border w-full mt-5 mb-4 "></div>
              <div className="flex flex-col gap-4">
                <p className="text-lg md:text-xl font-bold mb-1">Cost</p>
...
export default CompleteUniversityNo;
